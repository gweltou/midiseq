...
class Seq():
    ...
    # def getInScale(self, n):
    #     """ get the n-th degree of a note relative to the current musical scale and rootnote
    #         Parameters
    #         ----------
    #             pitch: int
    #                 the base note [0-127]
    #             n: int
    #                 the degree, relative to the base note (can be negative)
    #     """

    #     # oct_offset, deg_offset = divmod(n, 12)

    #     # octave, degree = divmod(pitch, 12)
    #     # degree = self.rootnote % 12
    #     distances = [s - self.rootnote % 12 for s in self.scale]
    #     print(distances)
    ...
    #     if n >= 0:
    #         distances = distances[off:] + [x+12 for x in distances[0:off]]
    #     else:  # Negative number
    #         distances = [-(x-12 + 1) for x in distances[off:]] + [-x-1 for x  in distances[0:off]]
    #         distances.reverse()
    #     # print(distances, end=" ")
