...
t1 = Track(env.default_output, 0, name="t1")
t2 = Track(env.default_output, 1, name="t2", sync_from=t1)
t3 = Track(env.default_output, 2, name="t3", sync_from=t1)
t4 = Track(env.default_output, 3, name="t4", sync_from=t1)
t5 = Track(env.default_output, 4, name="t5", sync_from=t1)
t6 = Track(env.default_output, 5, name="t6", sync_from=t1)
t7 = Track(env.default_output, 6, name="t7", sync_from=t1)
t8 = Track(env.default_output, 7, name="t8", sync_from=t1)
t9 = Track(env.default_output, 8, name="t9", sync_from=t1)
t10 = Track(env.default_output, 9, name="t10", sync_from=t1)
t11 = Track(env.default_output, 9, name="t11", sync_from=t10)
t12 = Track(env.default_output, 9, name="t12", sync_from=t10)
t13 = Track(env.default_output, 9, name="t13", sync_from=t10)
t14 = Track(env.default_output, 9, name="t14", sync_from=t10)
t15 = Track(env.default_output, 9, name="t15", sync_from=t10)
t16 = Track(env.default_output, 9, name="t16", sync_from=t10)
