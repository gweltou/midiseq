        ...
        if is_playing:
            ...
            if metronome_time > 0.5:
                ...
                if env.METRONOME:
                    ...
                    if env.default_output is not None:
                        env.default_output.push(rel_time, note_on)
                        env.default_output.push(rel_time + env.METRONOME_DUR, note_off)

            # Get midi messages from tracks
            for track in tracks.priority_list:
                track.process(time_delta)
